        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VotingRounds_Households_HouseholdId",
                        column: x => x.HouseholdId,
                        principalTable: "Households",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavoriteCuisines = table.Column<string[]>(type: "text[]", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CookEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CookEvents_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CookEvents_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VotingNominations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VotingNominations_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VotingNominations_VotingRounds_RoundId",
                        column: x => x.RoundId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VotingVotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VotingVotes_VotingRounds_RoundId",
                        column: x => x.RoundId,
                        principalTable: "VotingRounds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CookEvents_RecipeId",
                table: "CookEvents",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_CookEvents_UserId",
                table: "CookEvents",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VotingNominations_RecipeId",
                table: "VotingNominations",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_VotingNominations_RoundId",
                table: "VotingNominations",
                column: "RoundId");

            migrationBuilder.CreateIndex(
                name: "IX_VotingRounds_HouseholdId",
                table: "VotingRounds",
                column: "HouseholdId");

            migrationBuilder.CreateIndex(
                name: "IX_VotingVotes_RoundId_UserId",
                table: "VotingVotes",
